    ...
    try {
        ...
        const newProducts = [
            ...
            },
            {
                ...
                description: 'Value pack (2 x 250g packets) of our premium organic moringa powder. The most economical choice for families or power users who love their daily moringa boost.',
                short_description: '2x 250g Packets (500g Total) - Premium Organic Moringa Leaf Powder',
                price: 1799,
                original_price: 2199,
                category: 'Powder',
                in_stock: true,
                featured: true,
                images: ['/images/products/product-1.png', '/images/products/product-2.png'],
                benefits: ['2 Packets of 250g each (500g Total)', 'Maximum savings', 'Boosts energy naturally', 'Rich in antioxidants', 'Supports immune system'],
                ingredients: ['100% Organic Moringa Oleifera Leaves'],
                how_to_use: 'Mix 1 teaspoon (3g) in water, smoothie, or juice.',
                certifications: ['USDA Organic', 'Non-GMO', 'Vegan'],
                rating: 4.9,
